...
<div class="container my-5 py-5 z-depth-1" v-if="product"> 
  ...
  <section class="text-center">
    ...
    <!-- Section heading -->
    <h3 class="font-weight-bold mb-5">Produktinformation</h3>
          ...
          <div class="mt-5">
            ...
            <div class="row mt-3">
              <div class="col-md-12 text-center text-md-left text-md-right">
               ...
               <button class="btn btn-primary btn-rounded" v-on:click="addProductToCart({product, quantity})">  <!-- v-on:click="addProductToCart({product, quantity})"-->
                  <i class="fas fa-cart-plus mr-2" aria-hidden="true"></i> Lägg till varukorgen</button>
              </div>
            </div>
          </div>
        </section>
...
export default {
  ...
  methods: {
    ...mapActions(['getProductById', 'addProductToCart']) // hämtar actions från store/index
  },
  created() {
    this.getProductById(this.id)
  },
  computed: {
    ...mapGetters(['product'])  // hämta getters (en produkt) från store/index state.product
  }
}
</script>
